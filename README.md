...
This is achieved with `gtex.sh` and `gtex.subs` using weights from the GTEx project. File `GTEX_WEIGHTS.bim` was sorted by RSid and `GTEX_WEIGHTS.lst` was created to facilitate the imputation.
